...
def seq_gen(len_seq, data_seq, offset, n_frame, n_route, day_slot, C_0=1, len_all=60):
    '''
...
def data_gen(file_path, data_config, n_route, n_frame=21, day_slot=14):
    ...
    seq_val = seq_gen_val(n_val, data_seq, n_train, n_frame, n_route, day_slot)
    seq_test = seq_gen_test(n_test, data_seq, n_train + n_val, n_frame, n_route, day_slot)
